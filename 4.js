...
//pk.eyJ1IjoiYXJjaGl0MTA4IiwiYSI6ImNseDNtZXl4ZDB2cGgyanF1eDZpNHQxbDkifQ.AZm4BVNOXDisTIL4I8iaFw
...
const forwardGeocode = async (searchText) => {
    const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/515%2015th%20St%20NW%2C%20Washington%2C%20DC%2020004.json?types=${searchText}&access_token=${accessToken}`;
    try {
